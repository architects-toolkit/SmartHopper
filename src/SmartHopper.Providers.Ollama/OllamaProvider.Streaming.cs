...
{
    /// <summary>
    /// Streaming half of <see cref="OllamaProvider"/>.
    /// </summary>
    public sealed partial class OllamaProvider
    {
        ...
        {
            return new OllamaStreamingAdapter(this);
        }

        /// <summary>
        /// Provider-scoped streaming adapter for Ollama Chat Completions SSE.
        /// Ollama follows the OpenAI streaming protocol (data: {...}\n\n + [DONE]).
        /// </summary>
        private sealed class OllamaStreamingAdapter : AIProviderStreamingAdapter, IStreamingAdapter
        {
                ...
                [EnumeratorCancellation] CancellationToken cancellationToken = default)
            {
                ...
                try
                {
                    var apiKey = ((OllamaProvider)this.Provider).GetApiKey();
