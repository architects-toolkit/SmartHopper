...
{
    /// <summary>
    /// Factory class for creating instances of the LocalAI provider and its settings.
    /// This class is discovered by the ProviderManager through reflection.
    /// </summary>
    public class LocalAIProviderFactory : IAIProviderFactory
    {
        /// <inheritdoc/>
        ...
        {
            return new LocalAIProviderSettings(LocalAIProvider.Instance);
        }
    }
}
