 ...
 * Copyright (C) 2024-2026 Marc Roca Musach + SmartHopper Community
 *
 * SPDX-License-Identifier: MIT
 *
 * This file is part of the SmartHopper Provider SDK and is licensed under
 * the MIT License. See LICENSE in this folder for the full license text.
 */
