...
namespace SmartHopper.Infrastructure.Tests.AICall.Execution
{
    ...
    public class DefaultProviderExecutorTests
    {
        ...
        private sealed class TestableRequest : AIRequestCall
        {
            ...
            public override (bool IsValid, System.Collections.Generic.List<SHRuntimeMessage> Errors) IsValid()
            {
                return (true, new System.Collections.Generic.List<SHRuntimeMessage>());
            }
