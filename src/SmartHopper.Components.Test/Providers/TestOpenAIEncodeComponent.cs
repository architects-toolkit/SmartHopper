        ...
        private sealed class Worker : AsyncWorkerBase
        {
            ...
            public override async Task DoWorkAsync(CancellationToken token)
            {
                try
                {
                    ...
                    {
                        _success = new GH_Boolean(false);
                        _messages.Add(new GH_String("Missing system role (Context message)"));
                        await Task.Yield();
                        return;
                    }
                    ...
                    _messages.Add(new GH_String("OpenAI encoding successful"));
            ...
            public override void SetOutput(IGH_DataAccess DA, out string message)
            {
                ...
                message = _success.Value ? "OpenAI encoding test passed" : "OpenAI encoding test failed";
            }
        }
    }
}
