...
namespace SmartHopper.Components.Test.Providers
{
    ...
    {
        public override Guid ComponentGuid => new Guid("18A7D581-B871-42A2-AB35-6DC321FE42D0");
        protected override string ComponentName => "Test Anthropic Standard Call";
        protected override string ComponentDescription => "Tests Anthropic standard API call and metrics validation";
