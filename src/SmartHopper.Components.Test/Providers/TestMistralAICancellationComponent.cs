...
namespace SmartHopper.Components.Test.Providers
{
    ...
    public class TestMistralAICancellationComponent : AIStatefulAsyncComponentBase
    {
        ...
        private sealed class Worker : AsyncWorkerBase
        {
            ...
            private readonly TestMistralAICancellationComponent _parent;

            public Worker(TestMistralAICancellationComponent parent, Action<GH_RuntimeMessageLevel, string> addRuntimeMessage)
            ...
            public override void SetOutput(IGH_DataAccess DA, out string message)
            {
                ...
                message = anyPassed ? "MistralAI cancellation tests completed" : "MistralAI cancellation tests completed (no cancellations triggered)";
            }
        }
    }
}
