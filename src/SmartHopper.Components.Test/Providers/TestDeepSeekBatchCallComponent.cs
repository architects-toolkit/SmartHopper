...
namespace SmartHopper.Components.Test.Providers
{
    ...
    {
        public override Guid ComponentGuid => new Guid("7D757921-1E86-4D0D-99C5-0CFF2CBCD029");
        protected override string ComponentName => "Test DeepSeek Batch Call";
        protected override string ComponentDescription => "Tests DeepSeek batch API call with service_tier=batch and metrics validation";
        ...
        private sealed class Worker : AsyncWorkerBase
        {
            ...
            public override async Task DoWorkAsync(CancellationToken token)
            {
                try
                {
                    ...
                    if (provider == null)
                    {
                        _messages.Add(new GH_String("DeepSeek provider not found"));
            ...
            public override void SetOutput(IGH_DataAccess DA, out string message)
            {
                ...
                message = _callSuccess.Value && _metricsValid.Value ? "DeepSeek batch call test passed" : "DeepSeek batch call test failed";
            }
        }
    }
}
