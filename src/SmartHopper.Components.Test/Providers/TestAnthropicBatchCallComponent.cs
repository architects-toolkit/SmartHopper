...
namespace SmartHopper.Components.Test.Providers
{
    ...
    {
        public override Guid ComponentGuid => new Guid("45283AEC-C5CA-4040-87E7-7A28679E9E84");
        protected override string ComponentName => "Test Anthropic Batch Call";
        protected override string ComponentDescription => "Tests Anthropic batch API call with service_tier=batch and metrics validation";
        ...
        private sealed class Worker : AsyncWorkerBase
        {
            ...
            public override void SetOutput(IGH_DataAccess DA, out string message)
            {
                ...
                message = _callSuccess.Value && _metricsValid.Value ? "Anthropic batch call test passed" : "Anthropic batch call test failed";
            }
        }
    }
}
