...
namespace SmartHopper.Components.Test.Providers
{
    ...
    public class TestGeminiCancellationComponent : AIStatefulAsyncComponentBase
    {
        ...
        private sealed class Worker : AsyncWorkerBase
        {
            ...
            private readonly TestGeminiCancellationComponent _parent;

            public Worker(TestGeminiCancellationComponent parent, Action<GH_RuntimeMessageLevel, string> addRuntimeMessage)
            ...
            public override void SetOutput(IGH_DataAccess DA, out string message)
            {
                ...
                message = anyPassed ? "Gemini cancellation tests completed" : "Gemini cancellation tests completed (no cancellations triggered)";
            }
        }
    }
}
