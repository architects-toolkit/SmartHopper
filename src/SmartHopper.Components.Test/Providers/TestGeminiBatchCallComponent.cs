...
namespace SmartHopper.Components.Test.Providers
{
    ...
    public class TestGeminiBatchCallComponent : AIStatefulAsyncComponentBase
    {
        ...
        private sealed class Worker : AsyncWorkerBase
        {
            ...
            private readonly TestGeminiBatchCallComponent _parent;

            public Worker(TestGeminiBatchCallComponent parent, Action<GH_RuntimeMessageLevel, string> addRuntimeMessage)
