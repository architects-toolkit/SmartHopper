        ...
        private sealed class Worker : AsyncWorkerBase
        {
            ...
            public override async Task DoWorkAsync(CancellationToken token)
            {
                try
                {
                    ...
                    // Add System message (maps to system in DeepSeek)
                    ...
                    // Add User message (maps to user in DeepSeek)
                    bodyBuilder.Add(new AIInteractionText
                    {
                        Agent = AIAgent.User,
                    ...
                    // Check for required role mappings (DeepSeek uses system, user, assistant, tool)
