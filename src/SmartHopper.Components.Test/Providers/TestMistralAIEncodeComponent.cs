...
namespace SmartHopper.Components.Test.Providers
{
    ...
    public class TestMistralAIEncodeComponent : AIStatefulAsyncComponentBase
    {
        ...
        private sealed class Worker : AsyncWorkerBase
        {
            ...
            private readonly TestMistralAIEncodeComponent _parent;

            public Worker(TestMistralAIEncodeComponent parent, Action<GH_RuntimeMessageLevel, string> addRuntimeMessage)
            ...
            public override async Task DoWorkAsync(CancellationToken token)
            {
                try
                {
                    ...
                    // Add System message (maps to system in MistralAI)
                    ...
                    // Add User message (maps to user in MistralAI)
                    bodyBuilder.Add(new AIInteractionText
                    {
                        Agent = AIAgent.User,
                    ...
                    call.Initialize("MistralAI", "mistral-small-latest", call.Body, "/chat/completions", AICapability.Text2Text);
                    ...
                    // Check for required role mappings (MistralAI uses system, user, assistant, tool)
                    ...
                    this._messages.Add(new GH_String("MistralAI encoding successful"));
            ...
            public override void SetOutput(IGH_DataAccess DA, out string message)
            {
                ...
                message = this._success.Value ? "MistralAI encoding test passed" : "MistralAI encoding test failed";
            }
        }
    }
}
