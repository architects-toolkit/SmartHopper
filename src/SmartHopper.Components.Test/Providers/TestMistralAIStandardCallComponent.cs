...
{
    /// <summary>
    /// Test component for MistralAI standard API call.
    /// </summary>
    public class TestMistralAIStandardCallComponent : AIStatefulAsyncComponentBase
    {
        public override Guid ComponentGuid => new Guid("17302B7A-B89E-480B-AE4D-11006CED1DF9");
        protected override string ComponentName => "Test MistralAI Standard Call";
        protected override string ComponentDescription => "Tests MistralAI standard API call and metrics validation";
        ...
        private sealed class Worker : AsyncWorkerBase
        {
            ...
            private readonly TestMistralAIStandardCallComponent _parent;

            public Worker(TestMistralAIStandardCallComponent parent, Action<GH_RuntimeMessageLevel, string> addRuntimeMessage)
            ...
            public override void SetOutput(IGH_DataAccess DA, out string message)
            {
                ...
                message = _callSuccess.Value && _metricsValid.Value ? "MistralAI standard call test passed" : "MistralAI standard call test failed";
            }
        }
    }
}
