...
namespace SmartHopper.Components.Test.Providers
{
    ...
    public class TestOpenAICancellationComponent : AIStatefulAsyncComponentBase
    {
        ...
        private sealed class Worker : AsyncWorkerBase
        {
            ...
            private readonly TestOpenAICancellationComponent _parent;

            public Worker(TestOpenAICancellationComponent parent, Action<GH_RuntimeMessageLevel, string> addRuntimeMessage)
            ...
            public override async Task DoWorkAsync(CancellationToken token)
            {
                try
                {
                    ...
                    // Test 1: Standard API call cancellation
                    ...
                    // Test 2: Batch submit cancellation
                    ...
                    // Test 3: Batch remote cancellation
                    ...
                    // Test 4: Vision API call cancellation
            ...
            public override void SetOutput(IGH_DataAccess DA, out string message)
            {
                ...
                message = anyPassed ? "OpenAI cancellation tests completed" : "OpenAI cancellation tests completed (no cancellations triggered)";
            }
        }
    }
}
