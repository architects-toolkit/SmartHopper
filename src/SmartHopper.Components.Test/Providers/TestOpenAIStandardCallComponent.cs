...
namespace SmartHopper.Components.Test.Providers
{
    ...
    public class TestOpenAIStandardCallComponent : AIStatefulAsyncComponentBase
    {
        ...
        protected override string ComponentName => "Test OpenAI Standard Call";
        protected override string ComponentDescription => "Tests OpenAI standard API call and metrics validation";
        ...
        private sealed class Worker : AsyncWorkerBase
        {
            ...
            public override void SetOutput(IGH_DataAccess DA, out string message)
            {
                ...
                message = _callSuccess.Value && _metricsValid.Value ? "OpenAI standard call test passed" : "OpenAI standard call test failed";
            }
        }
    }
}
