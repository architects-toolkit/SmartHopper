...
namespace SmartHopper.Components.Test.DataProcessor
{
    ...
    public class DataTreeProcessorItemGraftTestComponent : StatefulComponentBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DataTreeProcessorItemGraftTestComponent"/> class.
        /// </summary>
        ...
        private sealed class Worker : AsyncWorkerBase
        {
            ...
            public override async Task DoWorkAsync(CancellationToken token)
            {
                try
                {
                    ...
                    bool ok =
                        ...
                        this._resultTree.get_Branch(expectedPath0) != null &&
                        this._resultTree.get_Branch(expectedPath0).Count == 1 &&
                        this._resultTree.get_Branch(expectedPath0)[0] is GH_Integer gi0 && gi0.Value == 11 &&
                        this._resultTree.get_Branch(expectedPath1) != null &&
                        this._resultTree.get_Branch(expectedPath1).Count == 1 &&
                        this._resultTree.get_Branch(expectedPath1)[0] is GH_Integer gi1 && gi1.Value == 22;

                    this._success = new GH_Boolean(ok);
                    this._messages.Add(new GH_String($"ItemGraft topology at path {path}. A=[1,2], B=[10,20]. Expected grafted results: {{{expectedPath0}}}=[11], {{{expectedPath1}}}=[22]."));
            ...
            public override void SetOutput(IGH_DataAccess DA, out string message)
            {
                ...
                message = this._success.Value ? "Processed ItemGraft topology successfully" : "Processing failed";
            }
        }
    }
}
