...
{
    /// <summary>
    /// Extension methods for <see cref="AIRuntimeMessage"/> to convert to Grasshopper-specific types.
    /// </summary>
    public static class AIRuntimeMessageExtensions
    {
        /// <summary>
        ...
        public static GH_RuntimeMessageLevel ToGrasshopperLevel(this AIRuntimeMessage message)
        {
