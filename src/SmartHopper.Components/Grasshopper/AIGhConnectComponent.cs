...
namespace SmartHopper.Components.Grasshopper
{
    ...
    {
        /// <inheritdoc/>
        public override Guid ComponentGuid => new Guid("190BDF18-B8C4-4C53-A09E-5C74016D0034");
        ...
        private sealed class AIGhConnectWorker : AsyncWorkerBase
        {
            ...
            public override async Task DoWorkAsync(CancellationToken token)
            {
                ...
                try
                {
                    ...
                    var toolResult = await this.parent.CallAIToolAsync("gh_smart_connect", parameters, token).ConfigureAwait(false);
