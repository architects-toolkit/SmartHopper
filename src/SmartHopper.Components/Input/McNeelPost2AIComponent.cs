...
{
    /// <summary>
    /// Retrieves a McNeel forum post by ID and wraps it into an AIInputPayload for AI processing.
    /// Uses the mcneel_forum_post_get AI tool with preset URL (https://discourse.mcneel.com).
    /// </summary>
    public class McNeelPost2AIComponent : StatefulComponentBase
    {
        private const string PresetBaseUrl = "https://discourse.mcneel.com";
        ...
        public McNeelPost2AIComponent()
            : base(
                "McNeel Post to AI",
                "McNeelPost2AI",
                "Retrieves a McNeel forum post by ID from discourse.mcneel.com and wraps it into an AIInputPayload.",
                "SmartHopper",
                "B. Input")
        {
        }
        ...
        {
            pManager.AddIntegerParameter("Post ID", "P", "ID(s) of the forum post(s) to retrieve from discourse.mcneel.com.", GH_ParamAccess.tree);
        }
        ...
        {
            return new McNeelPost2AIWorker(this, this.AddRuntimeMessage, this.ComponentProcessingOptions);
        }

        private sealed class McNeelPost2AIWorker : AsyncWorkerBase
        {
            private readonly McNeelPost2AIComponent parent;
            ...
            public McNeelPost2AIWorker(McNeelPost2AIComponent parent, Action<GH_RuntimeMessageLevel, string> addRuntimeMessage, ProcessingOptions options)
            ...
            public override void GatherInput(IGH_DataAccess DA, out int dataCount)
            {
                ...
                // Convert integer tree to string tree
            ...
            public override async Task DoWorkAsync(CancellationToken token)
            {
                ...
                {
                    Debug.WriteLine($"[McNeelPost2AIWorker] Error: {ex.Message}");
