...
{
    /// <summary>
    /// Retrieves a full Ladybug Tools Discourse forum post by its numeric ID.
    /// </summary>
    public class LadybugForumPostGetComponent : StatefulComponentBase
    {
        ...
        public LadybugForumPostGetComponent()
            : base(
                  "LadybugForum Post Get",
                  "LadybugPostGet",
                  "Retrieve a full Ladybug Tools Discourse forum post by its numeric ID.",
                  "SmartHopper",
                  "Knowledge")
        {
        ...
        {
            pManager.AddTextParameter("LadybugForum Post", "LbP", "JSON object representing the full forum post as returned by the tool.", GH_ParamAccess.tree);
        }
        ...
        {
            private readonly LadybugForumPostGetComponent parent;
            ...
            public LadybugForumGetPostWorker(
                LadybugForumPostGetComponent parent,
            ...
            {
                this.parent.SetPersistentOutput("LadybugForum Post", this.resultPosts ?? new GH_Structure<GH_String>(), DA);
