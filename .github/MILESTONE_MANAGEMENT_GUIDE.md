...
When `1.4.3-beta` is released:

- ✅ Creates `1.4.3-beta` milestone
- ✅ Closes `1.3.2-beta` (older beta in major version 1)
- ✅ **Does NOT** close `2.0.0-beta` (different major version)
- ✅ Creates `1.5.0-alpha` (next minor alpha)

When `2.0.0-beta` is released:

- ✅ Creates `2.0.0-beta` milestone
- ✅ Closes any older `2.x.x-beta` milestones
- ✅ **Does NOT** affect `1.x.x-beta` milestones
- ✅ Creates `2.1.0-alpha` (next minor alpha)
