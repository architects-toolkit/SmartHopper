...
- **Batch progress messages**: Live progress counter now shown during batch processing
...
- **`AIBatchStatus`**: Added optional `CompletedCount` property to non-completed status for in-progress progress reporting
