...
- **AI model registry refresh** across providers, aligned with official documentation (Apr 2026):
  - **OpenAI**: added `gpt-5.5` and `gpt-image-2`, completed default assignments for text, tools, reasoning, JSON, image, and audio capabilities, and excluded realtime endpoint models from the chat model registry.
