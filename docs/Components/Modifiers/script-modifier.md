...
Comprehensive modification of script components (Python, C#, VB, IronPython).
...
| Property | Value |
| --- | --- |
| **Source Code** | `src/SmartHopper.Core.Grasshopper/Utils/Components/ScriptModifier.cs` |
| **Since Version** | ? |
...
`ScriptModifier` provides a complete API for modifying script components programmatically, with 100% parity with GhJSON serialization capabilities. It enables automated updates to script code, parameters, type hints, and access types for Python, C#, VB, and IronPython components.

**You should read this if you:**

- Need to programmatically update script component code or parameters
- Are building AI tools that generate or edit Grasshopper script components
- Want to manage type hints, access types, or parameter properties on script components
- Need to understand how script modification maps to GhJSON serialization
