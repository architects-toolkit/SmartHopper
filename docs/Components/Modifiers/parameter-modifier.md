...
Modify parameter data settings on non-script components.
...
| Property | Value |
| --- | --- |
| **Source Code** | `src/SmartHopper.Core.Grasshopper/Utils/Components/ParameterModifier.cs` |
| **Since Version** | ? |
...
`ParameterModifier` provides focused operations for parameter data manipulation settings. Use this for modifying how parameters handle data flow (flatten, graft, reverse, simplify). It is designed specifically for non-script component parameters and works best when combined with other component manipulation tools.

**You should read this if you:**

- Need to modify data flow settings (flatten, graft, reverse, simplify) on Grasshopper component parameters
- Are building AI tools or automation scripts that need to manipulate component parameters programmatically
- Want to bulk-apply settings to multiple parameters at once
- Are working with non-script components and need to control their parameter behavior
