...
1. Create builder: `var builder = AIBodyBuilder.Create();`
2. Add interactions: `builder.Add(interaction1).Add(interaction2)...`
3. Configure filters: `builder.WithToolFilter(...).WithContextFilter(...)`
4. Set schema if needed: `builder.WithJsonOutputSchema(...)`
5. Finalize: `var immutableBody = builder.Build();`
